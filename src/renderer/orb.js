/**
 * Aura/particle orb animation engine.
 * Ported from MVP — renders on a <canvas> behind the character.
 */
class OrbAnimator {
  constructor(canvas) {
    this.canvas = canvas;
    ...
    this.targetColor = { r: 102, g: 126, b: 234 };
  ...
  _animate() {
    ...
    // Sound rings for listening/speaking
    ...
    for (const p of this.particles) {
      ...
      const wobble = this.state === 'thinking' ? Math.sin(this.time * 2 + p.angle * 3) * 8 : 0;
